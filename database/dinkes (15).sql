...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 19, 2014 at 08:55 AM
...
--
-- Constraints for table `peralatan_radiologi_rs`
--
ALTER TABLE `peralatan_radiologi_rs`
  ...
  ADD CONSTRAINT `peralatan_radiologi_rs_ibfk_1` FOREIGN KEY (`RS_NOREG`) REFERENCES `rumah_sakit` (`RS_NOREG`),
  ADD CONSTRAINT `peralatan_radiologi_rs_ibfk_2` FOREIGN KEY (`TAHUN_ID`) REFERENCES `tahun` (`TAHUN_ID`);
