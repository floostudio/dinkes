...
Class Export_Bab_SPM_1 {
    ...
    function downloadExcel($tahun) {
        ...
        $objPHPExcel->getActiveSheet()->fromArray($this->headerSpmIGD($tahun), null, 'A1');
        $objPHPExcel->getActiveSheet()->fromArray($this->dataSpm($tahun, 1, 9, null), null, 'A3');
        $objPHPExcel->getActiveSheet()->setTitle('SPM IGD');

        $objPHPExcel->createSheet(1);
        $objPHPExcel->setActiveSheetIndex(1);
        $objPHPExcel->getActiveSheet()->fromArray($this->headerSpmRJ($tahun), null, 'A1');
        $objPHPExcel->getActiveSheet()->fromArray($this->dataSpm($tahun, 2, 8, 10), null, 'A3');
        $objPHPExcel->getActiveSheet()->setTitle('SPM Rawat Jalan');

        $objPHPExcel->createSheet(2);
        $objPHPExcel->setActiveSheetIndex(2);
        $objPHPExcel->getActiveSheet()->fromArray($this->headerSpmRI($tahun), null, 'A1');
        $objPHPExcel->getActiveSheet()->fromArray($this->dataSpm($tahun, 3, 12, null), null, 'A3');
        $objPHPExcel->getActiveSheet()->setTitle('SPM Rawat Inap');

        $objPHPExcel->createSheet(3);
        $objPHPExcel->setActiveSheetIndex(3);
        $objPHPExcel->getActiveSheet()->fromArray($this->headerSpmBedah($tahun), null, 'A1');
        $objPHPExcel->getActiveSheet()->fromArray($this->dataSpm($tahun, 4, 7, null), null, 'A3');
        $objPHPExcel->getActiveSheet()->setTitle('SPM Bedah');

        $objPHPExcel->createSheet(4);
        $objPHPExcel->setActiveSheetIndex(4);
        $objPHPExcel->getActiveSheet()->fromArray($this->headerSpmPerinatologi($tahun), null, 'A1');
        $objPHPExcel->getActiveSheet()->fromArray($this->dataSpm($tahun, 5, 9, 14), null, 'A3');
        $objPHPExcel->getActiveSheet()->setTitle('SPM Perinatologi');*/


        $objPHPExcel->createSheet(0);
        $objPHPExcel->setActiveSheetIndex(0);
        $objPHPExcel->getActiveSheet()->fromArray($this->headerSpmIntensif($tahun), null, 'A1');
        $objPHPExcel->getActiveSheet()->fromArray($this->dataSpm($tahun, 6, 2, 17), null, 'A3');
        $objPHPExcel->getActiveSheet()->setTitle('SPM Pel. Intensif');


        $objPHPExcel->createSheet(1);
        $objPHPExcel->setActiveSheetIndex(1);
        $objPHPExcel->getActiveSheet()->fromArray($this->headerSpmLab($tahun), null, 'A1');
        $objPHPExcel->getActiveSheet()->fromArray($this->dataSpm($tahun, 8, 4, 22), null, 'A3');
        $objPHPExcel->getActiveSheet()->setTitle('SPM Laboratorium');

        $objPHPExcel->createSheet(2);
        $objPHPExcel->setActiveSheetIndex(2);
        $objPHPExcel->getActiveSheet()->fromArray($this->headerSpmRehabMedik($tahun), null, 'A1');
        $objPHPExcel->getActiveSheet()->fromArray($this->dataSpm($tahun, 9, 3, 24), null, 'A3');
        $objPHPExcel->getActiveSheet()->setTitle('SPM Rehab Medik');

        $objPHPExcel->createSheet(3);
        $objPHPExcel->setActiveSheetIndex(3);
        $objPHPExcel->getActiveSheet()->fromArray($this->headerSpmPelayananFarmasi($tahun), null, 'A1');
        $objPHPExcel->getActiveSheet()->fromArray($this->dataSpm($tahun, 10, 4, 28), null, 'A4');
        $objPHPExcel->getActiveSheet()->setTitle('SPM Pelayanan Farmasi');

        $objPHPExcel->createSheet(4);
        $objPHPExcel->setActiveSheetIndex(4);
        $objPHPExcel->getActiveSheet()->fromArray($this->headerSPMGizi($tahun), null, 'A1');
        $objPHPExcel->getActiveSheet()->fromArray($this->dataSpm($tahun, 11, 3, 31), null, 'A3');
        $objPHPExcel->getActiveSheet()->setTitle('SPM Gizi');
        ...
        header('Content-Disposition: attachment; filename="Rekap SPM Tahun ' . $tahun_rekap . '.xls"');
        ob_clean();
