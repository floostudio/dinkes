                ...
                <body>
                    ...
                    <section id="layout">
                        <div class="logo_profile container_12">
							...
							&nbsp;&nbsp;&nbsp; 
							<strong>Dinas Kesehatan Provinsi Jawa Timur</strong> 
                            </div>
                            </a>
                            <br/><br/><br/><div class="grid_6 profile_meta">
                                <div class="user_meta">
                                    ...
                                    <div class="name">
                                        Selamat datang <?php echo $this->user_name; ?> <br />
                                        <!--<a href="#" class="submeta">Profile</a>-->
                                        <a href="<?php echo site_url(); ?>/login/signout" class="submeta">Logout</a>
                                    </div>
                                </div>
                            </div>
                                ...
                                <section id="main_menu">
                                    <ul class="sf-menu">
                                        ...
                                        <li><a href="">Master Data</a>
                                            <ul>
                                                <li><a href="<?php echo site_url('/data_rs'); ?>">Data Rumah Sakit</a></li>
                                                <li><a href="<?php echo site_url('/data_tahun') ?> ">Data Tahun</a></li>
                                                
                                            </ul>
                                        </li>
                                        <li><a href="<?php echo site_url('/page_upload') ?>">Halaman Upload</a>
                                        </li>
                                        <li><a href="<?php echo site_url('/result_tabel') ?>">Laporan Rekap</a>
                                        </li>
                                        <!-- li><a href="<?php echo site_url('/charts') ?>">Laporan Grafik</a --> 
                                            <!--ul>
                                                    <li><a href="#"></a></li>
                                                    <li><a href="#">Rekap Masing-Masing Rumah Sakit</a></li>									
                                            </ul-->
                                        </li>
                                        <li><a href="<?php echo site_url('/validasi') ?>">Laporan Absensi</a>
                                        </li>
										 <li><a href="<?php echo site_url('/export1') ?>">Export</a>
                                        </li>
                                    </ul>							
                                    <div class="clear"></div>
