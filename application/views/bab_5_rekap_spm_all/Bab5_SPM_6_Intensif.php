...
?>
<h4>Tahun <?php echo $yearName.': '; ?>Bab 5 SPM Intensif</h4>
<thead>
    <tr>
        <th rowspan="2">No</th>
        ...
        <th colspan="4">Rata-rata Pasien yang kembali ke perawatan intensif dengan kasus yang sama <72</th> 
        <th colspan="4">Pemberi pelayanan Unit Intensif</th>  
