...
?>
<h4>Tahun <?php echo $yearName.': '; ?>Bab 5 SPM Limbah</h4>
<thead>
    <tr>
        <th rowspan="2">No</th>
        ...
        <th colspan="4">Baku mutu limbah cair </th> 
        <th colspan="4">Pengelolaan limbah padat infeksius sesuai dengan aturan</th>   
