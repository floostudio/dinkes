...
?>
<h4>Tahun <?php echo $yearName.': '; ?>Bab 5 SPM Pelayanan Laundry</h4>
<thead>
    <tr>
        <th rowspan="2">No</th>
        ...
        <th colspan="4">Tidak adanya linen yang hilang</td>
    <th colspan="4">Ketepatan waktu penyediaan linen untuk ruang rawat inap</td>
