...
?>
<h4>Tahun <?php echo $yearName.': '; ?>Bab 5 SPM Radiologi</h4>
<thead>
    <tr>
        <th rowspan="2">No</th>
        ...
        <th colspan="4">Waktu tunggu hasil pelayanan thorax foto</th> 
        <th colspan="4">Pelaksana ekspertisi</th>  
        <th colspan="4">Kejadian kegagalan pelayanan Rontgen</th> 
