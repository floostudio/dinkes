...
?>
<h4>Tahun <?php echo $yearName.': '; ?>Bab 5 SPM Farmasi</h4>
<thead>
    <tr>
        <th rowspan="2">No</th>
        ...
        <th colspan="4">Waktu tunggu pelayanana. Obat jadi</th> 
        <th colspan="4">Waktu tunggu pelayanana. Obat Racikan</th> 
        <th colspan="4">Kepuasan Pelanggan</th>  
        <th colspan="4">Penulisan resep sesuai formularium</th>  
