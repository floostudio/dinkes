...
?>
<h4>Tahun <?php echo $yearName.': '; ?>Bab 5 SPM Kegiatan Tranfusi</h4>
<thead>
    <tr>
        <th rowspan="2">No</th>
        ...
        <th colspan="4">Kebutuhan darah bagi setiap pelayanan tranfusi</th> 
        <th colspan="4">Kejadian Reaksi tranfusi</th>  
