...
?>
<h4>Tahun <?php echo $yearName . ': '; ?>Bab 5 SPM Kegiatan Rekam Medik</h4>
<thead>
    <tr>
        <th rowspan="2">No</th>
        ...
        <th colspan="4">Kelengkapan pengisian rekam medis 24 jam setelah selesai pelayanan.</th> 
        <th colspan="4">Kelengkapan Informed Concent setelah mendapatkan informasi yang jelas.</th>  
        <th colspan="4">Waktu penyediaan dokumen rekam medik pelayanan rawat jalan</th> 
        <th colspan="4">Waktu penyediaan dokumen rekam medik pelayanan rawat inap.</th>  
