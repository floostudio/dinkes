...
?>
<h4>Tahun <?php echo $yearName.': '; ?>Bab 5 SPM Pelayanan Rehabilitasi Medik</h4>
<thead>
    <tr>
        <th rowspan="2">No</th>
        ...
        <th colspan="4">Kejadian Drop Out pasien terhadap pelayanan Rehabilitasi Medik yang direncanakan</th> 
        <th colspan="4">Tidak adanya kejadian kesalahan tindakan rehabilitasi medik</th>  
