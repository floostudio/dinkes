...
for ($j = 0; $j < $rs_count; $j++) {
    for ($k = 0; $k < 10; $k++) {
        ...
        $total[$k] += $row[$track]->PENY_RI_JMLH;
        $track++;
    }
}
if($tipe == 1){
...
<script>
    (function basic_pie(container) {
        ...
        graph = Flotr.draw(container, [
            ...
            HtmlText: false,
            title: "Sepuluh penyakit Terbanyak Rawat Inap Tahun <?php echo $yearName; ?>",
            parseFloat: false,
            grid: {
                verticalLines: true,
    ...
    <script>
        (function basic_bars(container, horizontal) {
            ...
            graph = Flotr.draw(container, [
                ...
                shadowSize: 0,
                title: "Sepuluh besar Penyakit Rawat Inap Tahun: <?php echo $yearName; ?>",
                parseFloat: false,
                bars: {
                    show: true,
