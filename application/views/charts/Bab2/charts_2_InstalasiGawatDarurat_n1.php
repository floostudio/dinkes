...
for ($j = 0; $j < $rs_count; $j++) {
    $totalNilai[0] += $row[$track]->KIGD_PASIEN_L_N1;
    $totalNilai[1] += $row[$track]->KIGD_PASIEN_P_N1;
    $totalNilai[2] += $row[$track]->KIGD_PASIEN_TOTAL_N1;

    $track++;
}
$judul = "Instalasi Gawat Darurat Tahun Ke-".$yearName."-1";
