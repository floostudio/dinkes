...
for ($j = 0; $j < $rs_count; $j++) {
    $totalNilai[0] += $row[$track]->irj_pasien_l_n2;
    $totalNilai[1] += $row[$track]->irj_pasien_p_n2;
    $totalNilai[2] += $row[$track]->irj_pasien_total_n2;

    $track++;
}

$judul = "Instalasi Rawat Jalan Tahun Ke-".$yearName."-2";
