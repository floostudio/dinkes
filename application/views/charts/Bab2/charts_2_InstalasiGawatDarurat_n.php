...
for ($j = 0; $j < $rs_count; $j++) {
    $totalNilai[0] += $row[$track]->KIGD_PASIEN_L_N;
    $totalNilai[1] += $row[$track]->KIGD_PASIEN_P_N;
    $totalNilai[2] += $row[$track]->KIGD_PASIEN_TOTAL_N;

    $track++;
}

$judul = "Instalasi Gawat Darurat Tahun Ke-".$yearName;
