...
for ($j = 0; $j < $rs_count; $j++) {
    $totalNilai[0] += $row[$track]->irj_pasien_l_n;
    $totalNilai[1] += $row[$track]->irj_pasien_p_n;
    $totalNilai[2] += $row[$track]->irj_pasien_total_n;

    $track++;
}

$judul = "Instalasi Rawat Jalan Tahun Ke-".$yearName;
