...
for ($j = 0; $j < $rs_count; $j++) {
    ...
    for ($k = 0; $k < 10; $k++) {
        ...
        $totalN1[$ind] += $row[$track]->KASUS_TB_RI_JENIS_N1;
        $totalN[$ind] += $row[$track]->KASUS_TB_RI_JENIS_N;
    ...
    (function basic(container) {
        ...
        graph = Flotr.draw(container, [
	     ...
	     markers: {
            ...
            shadowSize: 0,
            title: "Kasus TB Rawat Inap Berdasarkan Jenisnya Tahun <?php echo $yearName; ?>",
            parseFloat: false,
            xaxis: {
                title: "Tahun",
                min: 0,
